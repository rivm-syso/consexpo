...
{
    [TestClass]
    public class TransferCoefficientTests
    {
        [TestMethod]
        public void TransferCoefficientUnitConversionTest()
        {
        ...
        [TestMethod]
        public void TransferCoefficientInSquareMetresPerSecondTest()
        {
        ...
        [TestMethod]
        public void TransferCoefficientInSquareCentimetrePerSecond()
        {
            var x = new DiffusionCoefficient()
            {
                Value = 60,
        ...
        [TestMethod]
        public void TransferCoefficientInSquareCentiMetresPerMinuteTest()
        {
            var x = new DiffusionCoefficient()
            {
                Value = 1,
        ...
        [TestMethod]
        public void TransferCoefficientInSquareMetresPerHourTest()
        {
